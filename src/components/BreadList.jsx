  ...
  return (
    <>
      ...
      <div className="text-center mb-10">
        <h1 className="text-4xl md:text-5xl font-bold text-[#3E2522] font-['Dancing_Script',cursive] mb-2">Daftar Produk Roti</h1>
        <p className="text-[#8C6E63] text-sm md:text-base">Freshly baked with love, just for you.</p>
      </div>
      ...
      <div className="max-w-md mx-auto mb-10">
        <div className="relative">
          ...
          />
          <svg xmlns="http://www.w3.org/2000/svg" className="absolute left-3 top-1/2 transform -translate-y-1/2 h-5 w-5 text-[#8C6E63]" fill="none" viewBox="0 0 24 24" stroke="currentColor">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 mb-10">
        {breads && breads.length > 0 ? (
          breads.map(bread => (
            <BreadCard key={bread.id} bread={bread} onEdit={onEdit} onDelete={onDelete} />
          ))
        ) : (
