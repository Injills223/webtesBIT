...
const Footer = () => {
  return (
    <footer className="bg-white border-t border-cream-pastel mt-auto">
        ...
        <div className="py-12 grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="md:col-span-1">
            ...
            <div className="flex gap-3 mt-6">
              <a href="#" className="w-10 h-10 bg-cream-pastel/50 rounded-full flex items-center justify-center text-accent-dark hover:bg-warm-beige hover:text-white transition-all">
              ...
              <a href="#" className="w-10 h-10 bg-cream-pastel/50 rounded-full flex items-center justify-center text-accent-dark hover:bg-green-500 hover:text-white transition-all">
                <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
